...
window.addEventListener('DOMContentLoaded', function () {
  ...
  modulesSlider.init();
  var feedsSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
      ...
      try {
        ...
        if (n === 3) {
          ...
          setTimeout(function () {
            ...
            _this.hanson.classList.add('slideUnUp');
          }, 3000);
        } else {
          this.hanson.classList.remove('slideUnUp');
        }
      } catch (e) {}
